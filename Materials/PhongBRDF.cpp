...
glm::vec3 Phong::ComputeReflectance(const HitInfo& hit, const Light& light, const ClassicMaterial& material) const
{
    ...
    color += (material.Specular() * std::pow(alpha, exponent)) / theta_i;
